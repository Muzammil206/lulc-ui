...
export interface YearResult {
  year: number; urlFormat: string; mapId: string; token: string; stats: LULCClass[]
}
export interface AOIMeta {
  key: string; label: string; state: string; zone: string
...
export interface AOIListResponse {
  locations:      AOILocation[]
  zones:          Record<string, AOILocation[]>
